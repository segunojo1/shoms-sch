...
const Spaces = () => {
  return (
    <Parallax className='h-[200vh] '   bgImage="Banner-Butterflies.png" bgImageAlt="spaces" strength={800}>
      <div className='w-[80%] mx-auto'>
        <div className='font-bold text-6xl mt-[5rem] mb-[2rem] w-[80%]'>Spaces still available in our Primary and Secondary Classes for 2022-2023</div> 
